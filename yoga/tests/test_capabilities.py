...
class TestCapabilities:
    ...
    def test_get_local_caps(self):
        ...
        caps = yoga.capabilities.Capabilities(args).get_local_capabilities()
        expected_caps = {
            'platformName': 'Android',
            'platformVersion': '6.0',
            'deviceName': 'Android Emulator',
    ...
    def test_get_remote_caps(self):
        ...
        with patch('yoga.capabilities.os') as mock_os:
            ...
            caps = yoga.capabilities.Capabilities(args).get_remote_capabilities()
        expected_caps = {
            'platform': 'Windows 10',
            'version': '68.0',
            'browserName': 'chrome'
    ...
    def test_get_formatted_remote_caps(self):
        ...
        with patch('yoga.capabilities.os') as mock_os:
            mock_os.path.join.return_value = self.temp_caps_file
            caps = yoga.capabilities.Capabilities(args).get_formatted_remote_capabilities()
